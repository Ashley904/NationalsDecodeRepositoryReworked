package org.firstinspires.ftc.teamcode.opmodes.autonomous.blueSide;
...
import org.firstinspires.ftc.teamcode.opmodes.teleop.NationalsTeleOp;
...
@Autonomous(name="Blue 9 Ball Close Zone Autonomous", group="Blue Side")
public class BlueAllianceCloseZoneAutonomous extends OpMode {
    ...
    private PathChain leaveStartingZonePathChain;
    //---------- ---------//
    ...
    public void init(){
        ...
        follower.setStartingPose(autonomousConstants.BlueSideCloseZoneConstants.startingPose);
    ...
    private void AutonomousPathing(){
        CommandScheduler.getInstance().schedule(
                new SequentialCommandGroup(
                        ...
                        new InstantCommand(() -> follower.followPath(collect2ndSetPathChain, 0.465, true)).alongWith(
                        ...
                        new WaitUntilCommand(() -> transferSubsystem.transferingSequenceCompleted),
                        new InstantCommand(() -> follower.followPath(collect3rdSetPathChain, 0.465, false)).alongWith(
                                new InstantCommand(() -> robotConstants.IntakeConstants.currentIntakeState = robotConstants.IntakeConstants.IntakeState.Intaking)
                        ),
                        new WaitUntilCommand(() -> !follower.isBusy()),
                        new WaitCommand(500),
                        ...
                        new WaitUntilCommand(() -> transferSubsystem.transferingSequenceCompleted),
                        new WaitUntilCommand(() -> !follower.isBusy()),
                        new InstantCommand(() -> follower.followPath(leaveStartingZonePathChain, 1.0, false))
                )
        );
    }
    ...
    private void initializePaths(){
        ...
        scorePreloadPathChain = follower.pathBuilder()
                .addPath(new BezierLine(autonomousConstants.BlueSideCloseZoneConstants.startingPose, autonomousConstants.BlueSideCloseZoneConstants.scorePreloadPose))
                .setLinearHeadingInterpolation(autonomousConstants.BlueSideCloseZoneConstants.startingPose.getHeading(), autonomousConstants.BlueSideCloseZoneConstants.scorePreloadPose.getHeading())
                .build();
        ...
        collect2ndSetPathChain = follower.pathBuilder()
                .addPath(new BezierLine(
                        autonomousConstants.BlueSideCloseZoneConstants.scorePreloadPose,
                        autonomousConstants.BlueSideCloseZoneConstants.collect2ndSetPose1))
                .setLinearHeadingInterpolation(
                        autonomousConstants.BlueSideCloseZoneConstants.scorePreloadPose.getHeading(),
                        autonomousConstants.BlueSideCloseZoneConstants.collect2ndSetPose1.getHeading())
                .addPath(new BezierLine(
                        autonomousConstants.BlueSideCloseZoneConstants.collect2ndSetPose1,
                        autonomousConstants.BlueSideCloseZoneConstants.collect2ndSetPose2))
                .setLinearHeadingInterpolation(
                        autonomousConstants.BlueSideCloseZoneConstants.collect2ndSetPose1.getHeading(),
                        autonomousConstants.BlueSideCloseZoneConstants.collect2ndSetPose2.getHeading())
                .build();

        score2ndSetPathChain = follower.pathBuilder()
                .addPath(new BezierLine(autonomousConstants.BlueSideCloseZoneConstants.collect2ndSetPose2, autonomousConstants.BlueSideCloseZoneConstants.score2ndSetPose))
                .setLinearHeadingInterpolation(autonomousConstants.BlueSideCloseZoneConstants.collect2ndSetPose2.getHeading(), autonomousConstants.BlueSideCloseZoneConstants.score2ndSetPose.getHeading())
                .build();
        ...
        //--------Collect + Score 3rd Set--------//
        collect3rdSetPathChain = follower.pathBuilder()
                .addPath(new BezierLine(
                        autonomousConstants.BlueSideCloseZoneConstants.score2ndSetPose,
                        autonomousConstants.BlueSideCloseZoneConstants.collect3rdSetPose1))
                .setLinearHeadingInterpolation(
                        autonomousConstants.BlueSideCloseZoneConstants.score2ndSetPose.getHeading(),
                        autonomousConstants.BlueSideCloseZoneConstants.collect3rdSetPose1.getHeading())
                .addPath(new BezierLine(
                        autonomousConstants.BlueSideCloseZoneConstants.collect3rdSetPose1,
                        autonomousConstants.BlueSideCloseZoneConstants.collect3rdSetPose2))
                .setLinearHeadingInterpolation(
                        autonomousConstants.BlueSideCloseZoneConstants.collect3rdSetPose1.getHeading(),
                        autonomousConstants.BlueSideCloseZoneConstants.collect3rdSetPose2.getHeading())
                .build();

        score3rdSetPathChain = follower.pathBuilder()
                .addPath(new BezierLine(autonomousConstants.BlueSideCloseZoneConstants.collect3rdSetPose2, autonomousConstants.BlueSideCloseZoneConstants.score3rdSetPose))
                .setLinearHeadingInterpolation(autonomousConstants.BlueSideCloseZoneConstants.collect3rdSetPose2.getHeading(), autonomousConstants.BlueSideCloseZoneConstants.score3rdSetPose.getHeading())
                .build();
        ...
        leaveStartingZonePathChain = follower.pathBuilder()
                .addPath(new BezierLine(autonomousConstants.BlueSideCloseZoneConstants.score3rdSetPose, autonomousConstants.BlueSideCloseZoneConstants.leaveStartingZonePose))
                .setLinearHeadingInterpolation(autonomousConstants.BlueSideCloseZoneConstants.score3rdSetPose.getHeading(), autonomousConstants.BlueSideCloseZoneConstants.leaveStartingZonePose.getHeading())
                .build();
    }
    ...
    private void CalculateShooterParameters() {
        double distance = follower.getPose().distanceFrom(robotConstants.FieldConstants.blueGoalFieldPose);
